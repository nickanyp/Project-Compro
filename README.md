...
# หลักการทำงาน
&emsp;เมื่อมีการกดปุ่มswitchการทำงาน ฟังก์ชั่นการrandomตัวเลขจะเริ่มทำการสุ่มตัวเลขขึ้นมาและจะเริ่มการทำงานทันที เมื่อมีการสุ่มตัวเลขทั้งหมดเสร็จ หลอดไฟLEDทั้ง6ดวงจะขึ้นตามตัวเลขที่ฟังก์ชั่นrandomได้ลูปขึ้นมา หลังจากนั้น 7-segment display จะขึ้นตามตัวเลขที่หลอดไฟLEDได้ปรากฎเมื่อสักครู่
